...
la lógica de la programación para la resolución de problemas sencillos; en donde aprendí a utilizar las estructuras condicionales (if, else if, swich case), 
los búcles (for, for each, while, do while) y los subsistemas (funciones). Con JavaScrip (Nodejs) además de aplicar los principios ya mencionados, también 
